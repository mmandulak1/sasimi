...
print("Graph,Method,Delta,#Sets,Init,Gen,Ref,Ver,Total,#Surv,Recall,Prec")
    ...
    if os.path.isfile(filepath):  # Ensure it's a file
        with open(filepath, 'r', encoding='utf-8') as file:
            ...
            for line in file:
                ...
                if 'Delta' in line:
                    delta = float(line.rstrip().split(':')[-1])
                if 'Progress' in line:
                ...
                if 'Survived' in line:
                    ...
                    dataset.append([dataname, method, delta, numsets, timings[0],timings[1],timings[2],timings[3], timings[4],numsurv])

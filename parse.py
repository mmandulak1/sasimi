...
print("Graph,Method,Delta,#Sets,%Dataset,Init,Gen,Ref,Ver,Total,#Surv,Recall,Prec")
...
with open(filepath, 'r', encoding='utf-8') as file:
    ...
    for line in file:
        ...
        if "Samples" in line:
            numsets = line.rstrip().split(' ')[2]
            sampleamnt = line.rstrip().split(' ')[-1]
        if "Delta" in line:
            deltaVar = line.rstrip().split(" ")[-1]
        #if 'Progress' in line:
        ...
        if 'Survived' in line:
            ...
            dataset.append([dataname, method, deltaVar, numsets, sampleamnt,timings[0],timings[1],timings[2],timings[3], timings[4],numsurv])
